...
const InvoiceTemplate: React.FC<FlowInvoiceProps> = ({ data }) => {
    ...
    items: [
      {
        ...
        details:
          "Lorem ipsum dolor sit amet consectetur adipiscing elitenid diam sit amet consectetur",
        quantity: 5,
        rate: 50.0,
        price: 2500.0,
      },
      {
        ...
        details:
          "Lorem ipsum dolor sit amet consectetur adipiscing elitenid diam sit amet",
        quantity: 3,
        rate: 20.0,
        price: 600.0,
      },
      {
        ...
        details:
          "Adipiscing consectetur lorem ipsum dolor sit amet consectetur",
        quantity: 10,
        rate: 100.0,
        price: 1000.0,
      },
      ...
      },
      {
        ...
        details:
          "Sapien rhoncus elit adipiscing consectetur lorem ipsum consectetur",
        quantity: 3,
        rate: 500.0,
        price: 1500.0,
      },
  ...
  return (
    <div
      className="max-w-4xl mx-auto p-6 font-sans text-sm leading-tight"
      style={{ background: "#fff" }}
    >
      {/* Header */}
      <div className="flex justify-between items-start mb-6">
        <div
          className="text-xs space-y-0.5 leading-relaxed"
          style={{ color: "#6b7280" }}
        ></div>
      ...
      <div className="flex mb-6">
        ...
        >
          <h1 style={{ fontSize: 16, fontWeight: 600, letterSpacing: 1 }}>
            INVOICE
          </h1>
        </div>
        <div
          ...
          {invoiceData.items.map((item, index) => (
            ...
            >
              <div style={{ padding: 10, borderRight: "1px solid #000" }}>
                ...
                {item.details && (
                  <div
                    style={{ color: "#6b7280", fontSize: 12, lineHeight: 1.3 }}
                  >
                    {item.details}
                  </div>
                )}
