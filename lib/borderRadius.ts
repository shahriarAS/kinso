 ...
 */
export const getRoundedClass = (component: keyof typeof COMPONENT_ROUNDS): string => {
 ...
 */
export const getRoundedStyle = (size: keyof typeof BORDER_RADIUS): { borderRadius: string } => {
  return {
