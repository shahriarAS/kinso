...
import { Card, Row, Col, Statistic, Table, Tag, Space, Spin, Alert, Empty, Skeleton } from 'antd';
import { 
  ...
  if (statsLoading) {
    return (
      <div className="p-6 space-y-6">
        {/* Header Skeleton */}
        <div className="mb-6">
          <Skeleton.Input active size="large" style={{ width: 240, height: 36, marginBottom: 8 }} />
          <Skeleton.Input active size="small" style={{ width: 320, height: 20 }} />
        </div>
          ...
          {[1, 2, 3, 4].map((i) => (
            <Col xs={24} sm={12} lg={6} key={i}>
              <Card className="bg-white border rounded-2xl shadow-sm">
                ...
                <Skeleton.Input active size="large" style={{ width: 120, height: 32, marginTop: 8 }} />
              </Card>
            </Col>
          ))}
        </Row>
