...
export default function CartDetails({
  ...
  const [useSalesSystem, setUseSalesSystem] = useState(true); // Always use sales system now
  ...
  const confirmCheckout = () => {
    // This will be handled by the sales completion component
    if (onSaleComplete) {
      onSaleComplete({
        outletId: selectedOutlet,
        customerId: customer || undefined,
        paymentMethod: "CASH", // Default to cash, can be changed in the modal
